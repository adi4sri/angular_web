...
var CreatePassword = (function () {
    function CreatePassword(auth, http, authHttp, workersService, route, router) {
        this.auth = auth;
        this.http = http;
    ...
    CreatePassword.prototype.createPassword = function () {
        var _this = this;
        if (this.password.length < 8) {
            ...
            this.workersService.createPassword(this.token, this.password2)
                ...
                _this.success = "Password has been reset. You will be redirected to login page in " + _this.n + " seconds.";
            })
